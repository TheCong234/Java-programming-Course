...
public class answer {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println("Nhap so n: ");
        // int n = sc.nextInt();
        // System.out.println("So dao nguoc cua "+n+" la: "+answer.Bai13_Reverse(n));
        ...
        // int[][] arr = answer.NhapMaTrix(m, n);
        // System.out.println("Ma tran vua nhap la: ");
        // answer.XuatMaTrix(arr, m, n);
        // System.out.println();
        // int col;
        // do {
        ...
        //     }
        // } while (col>=n||col<0);
        // System.out.println("Tong cua cot "+col+" la: "+answer.Bai16_TongCot_Matrix(arr, col));
